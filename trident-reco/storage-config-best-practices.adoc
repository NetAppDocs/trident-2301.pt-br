...
A utilização de uma política de QoS ONTAP aplicada à SVM limita o número de consumíveis de IOPS pelos volumes provisionados pelo Trident. Isso ajuda https://docs.netapp.com/us-en/ontap/performance-admin/guarantee-throughput-qos-task.html["evite um bully"^] a evitar que o volume fora de controle afete workloads fora do SVM do Trident.
...
Para obter mais informações sobre grupos de políticas de QoS, https://docs.netapp.com/us-en/ontap-cli-98/index.html["Comandos de QoS ONTAP 9.8"^] consulte .
...
* https://docs.netapp.com/us-en/ontap/san-admin/index.html["Gerenciamento de STORAGE SAN"^] (Para iSCSI)
* https://docs.netapp.com/us-en/ontap/san-admin/provision-storage.html["Configuração iSCSI Express para RHEL"^]
